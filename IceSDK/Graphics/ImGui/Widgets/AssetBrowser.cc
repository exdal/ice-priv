...
void AssetBrowser::Init(Memory::Ptr<Assets::AssetManager> pManager)
{
	...
	g_CachedTexture.push_back(Graphics::Texture2D::Load("AnimatedTexture", std::vector<uint8_t>(&animated_texture_png[0], &animated_texture_png[animated_texture_png_len])));
